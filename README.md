...
You will need to set up your .env files. You can use the .env.example files as a guide. Ensure you have the appropriate .env files created and populated in:
